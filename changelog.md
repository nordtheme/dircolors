...
❯ Implemented the main color theme file [`dir_colors`](https://github.com/nordtheme/dircolors/blob/develop/src/dir_colors). (@svengreb, #1, aa0b485a)

❯ Implemented a [`install.sh`](https://github.com/nordtheme/dircolors/blob/develop/install.sh) shell script for an automated installation . (@svengreb, #2, 9326ee6a)

Detailed information about features and install instructions can be found in the [README](https://github.com/nordtheme/dircolors/blob/develop/README.md#installation) and in the [project wiki](https://github.com/nordtheme/dircolors/wiki).

<p align="center"><img src="https://raw.githubusercontent.com/nordtheme/dircolors/develop/src/assets/scrot-preview.png"/></p>
